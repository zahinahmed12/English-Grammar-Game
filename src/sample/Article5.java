...
public class Article5 {
    ...
    public void init(Client c) {
        this.c = c;
        Image img = new Image(Main.class.getResourceAsStream("Article5.png"));
        image.setImage(img);
    }
    ...
    public void b3Clicked(){
        try{
            c.oos.writeObject("ArticleScore");
            main.showTopicFinal(c,3, (Integer)c.ois.readObject());
        }catch(Exception e){
            e.printStackTrace();
        }
    }
